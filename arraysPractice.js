...
//******OR******  alert each item one at a time;
var reversedLooper2 = function(array) {
  var bass = array.reverse();
  for(var i = 0; i < bass.length; i++) {
    alert(bass[i]);
  };
};
reversedLooper2(letters);
...
//*****OR*****
var evenFinder2 = function(array) {
  var evens = [];
  for(var i = 0; i < array.length; i++) {
    if(array[i] % 2 === 0) {
      evens.push(array[i]);
...
//Write a function called reverse that takes is given str as it's only argument and returns that string after it's been reversed
  ...
  //Code Here   ****TOTALLY reversed  ecnetens ym si siht
var reverse = function(string) {
  return string.split("").reverse().join("");
};
reverse(str);

//*****OR*****  *****words reversed   sentence my is this
...
var longer = function(array1, array2) {
  ...
  if(array1.length > array2.length) {
    return "Arr1 is longer: " + array1;
  }
  else if(array2.length > array1.length) {
    return "Arr2 is longer: " + array2;
  }
  else {
    return "Same length";
  }
